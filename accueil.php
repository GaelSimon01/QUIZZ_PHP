...
<body>
    ...
    <ul>
        <?php foreach ($questionnaires as $id => $questionnaire) : ?>
            <li><?php echo $questionnaire['intitule'] ?>, theme : <?php echo $themes[$questionnaire['idTheme']] ?> <a href="quizz.php?quizz=<?php echo $questionnaire['intitule'] ?>">Faire le quizz</a></li>
        <?php endforeach; ?>
    </ul>
